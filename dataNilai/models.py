...
class nilaiMahasiswa(models.Model):
    ...
    hasil_ukmppd = models.IntegerField(choices=[(0, 'Retake'), (1, 'Lulus')], null=True, blank=True)
    solution = models.CharField(max_length=1024, blank=True, null=True)
...
class Meta:
    db_table = 'nilaiMahasiswa'

class caseRetake(models.Model):
